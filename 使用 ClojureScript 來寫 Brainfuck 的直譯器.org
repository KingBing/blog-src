...
#+HTML: <div class="row "><div class="col-md-6 offset4">
#+BEGIN_HTML
    <!-- Button to trigger modal -->
    <a href="#clojurescript_example" role="button" class="btn btn-danger" data-toggle="modal">Brainfuck Interpreter in ClojureScript</a>
